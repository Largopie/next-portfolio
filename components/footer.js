        ...
        <div>
          <div className="container flex flex-col items-center px-5 py-6 mx-auto sm:flex-row">
            <Link href="/" className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
              <span className="ml-3 text-xl">송재석 포트폴리오</span>
            </Link>
            <p className="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0">Frontend Engineer</p>
            <span className="inline-flex justify-center mt-4 sm:ml-auto sm:mt-0 sm:justify-start">
              ...
              <a href="https://github.com/Largopie" className="ml-3 text-gray-500">
